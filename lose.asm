lose:				;Label where the code starts.
	...
	mov si, lose_message	;Beginning of the intoduction String
	call print_mono_lose	;Procedure to print the string
...
;Strings
lose_message db 'You L.O.S.E :(',0

print_mono_lose:
	mov bl,7		;Initial value of the color
